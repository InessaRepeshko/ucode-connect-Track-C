...
////            printf("%d", mx_list_size(((t_path_vertex *)((t_path_vertex *) vertex2)->previous->data)->previous));
//            if(mx_list_size(((t_path_vertex *)((t_path_vertex *) vertex2)->previous->data)->previous) > 1) { //vertex2 = P
//                mx_sort_list((t_list*)((t_path_vertex *)vertex2)->previous, vertex2, compare_island);
//            }
//            vertex2 = ((t_path_vertex *) vertex2)->previous->data;
//        }
//        printf("%ld", (((t_path_vertex *) vertex2)->island_index));
...
////            printf("%d", mx_list_size(((t_path_vertex *)((t_path_vertex *) vertex1)->previous->data)->previous));
////            printf("%d", mx_list_size(((t_path_vertex *)((t_path_vertex *) vertex2)->previous->data)->previous));
//            if(mx_list_size(((t_path_vertex *)((t_path_vertex *) vertex1)->previous->data)->previous) > 1) {
//                mx_sort_list((t_list*)((t_path_vertex *)vertex1)->previous, vertex1, compare_island);
//            }
//            vertex1 = ((t_path_vertex *) vertex1)->previous->data;
//
//        }
////        bool g = ((t_path_vertex *) vertex)->island_index < ((t_path_vertex *) vertex1)->island_index;
////        printf("%d",g);
